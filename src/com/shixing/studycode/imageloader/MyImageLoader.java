...
public class MyImageLoader {
    ...
    protected Bitmap getBitmapFromLruCache(String key) {
     ...
     * @return
     */
    protected Bitmap decodeSampleBitmapFromResource(String pathName, int reqWidth,
            int reqHeight) {
     ...
     * @return
     */
    protected ImageSize getImageViewWidth(ImageView imageView) {
